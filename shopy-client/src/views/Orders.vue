...
<v-content>
    ...
    <v-row class="card-order pa-6 to-column" v-for="(n,i) in visibleProducts" :key="i">
        <img src="https://i.ebayimg.com/images/g/NgUAAOSwZntccwEN/s-l300.jpg" class="card-order__image"/>
        <v-col class="ml-4">
            <Title size='title-secondary' style="text-align:start;">{{n.title}}</Title>
